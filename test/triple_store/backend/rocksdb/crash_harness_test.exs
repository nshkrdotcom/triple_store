defmodule TripleStore.Backend.RocksDB.CrashHarnessTest do
  ...
  won't bring down the main test runner.

  Excluded by default - run with: mix test --include crash_harness
  """

  use ExUnit.Case, async: false

  # Excluded by default to avoid subprocess interference
  @moduletag :crash_harness
